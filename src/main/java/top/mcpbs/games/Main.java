...
public class Main extends PluginBase {
    ...
    public void onEnable() {
        ...
        Server.getInstance().getCommandMap().register("",new AddPBC("addpbc","增加一个屏蔽词 <屏蔽词> <replace to>"));
        Server.getInstance().getCommandMap().register("",new RemPBC("rempbc","删除一个屏蔽词 <屏蔽词>"));
        Server.getInstance().getCommandMap().register("",new Report("report","举报玩家作弊"));
        Server.getInstance().getCommandMap().register("",new top.mcpbs.games.rush.JoinRoom("joinrush","快速加入rush房间"));
        ...
        Server.getInstance().getCommandMap().register("",new top.mcpbs.games.lottery.LotteryCmd("lottery","抽奖箱系统"));
        Server.getInstance().getCommandMap().register("",new top.mcpbs.games.laba.LabaCmd("laba","小喇叭（发送全服消息）"));
        ...
        Server.getInstance().getCommandMap().register("",new top.mcpbs.games.chao.ChaoStore("chaostore","大乱斗商店"));
        ...
        Server.getInstance().getCommandMap().register("",new top.mcpbs.games.npc.AddNPCCMD("addnpc","addnpc <name> <alwayssave> <keepface> <cmd>"));
        Server.getInstance().getCommandMap().register("",new top.mcpbs.games.npc.RemNPCCMD("remnpc","remnpc <id>"));
        Server.getInstance().getCommandMap().register("",new top.mcpbs.games.npc.GetNearestNPCIDCMD("getnnpc"));
