...
public class Main extends PluginBase {
    ...
    public void onEnable() {
        ...
        s = new ScoreboardDe();this.getLogger().info("      ___.                                              ");
        ...
        LoadCmd.loadCmd();
        Server.getInstance().getCommandMap().register("",new Hub("hub","返回主城",this));
        ...
        Server.getInstance().getCommandMap().register("",new DesignationCmd("ch","称号系统"));
