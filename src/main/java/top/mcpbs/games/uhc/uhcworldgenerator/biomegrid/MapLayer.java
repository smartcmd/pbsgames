package top.mcpbs.games.uhc.uhcworldgenerator.biomegrid;

import cn.nukkit.level.Level;
import cn.nukkit.level.biome.EnumBiome;
import cn.nukkit.level.generator.Generator;
import cn.nukkit.math.NukkitRandom;
import top.mcpbs.games.uhc.uhcworldgenerator.VanillaGenerator;
import top.mcpbs.games.uhc.uhcworldgenerator.biomegrid.MapLayerWhittaker.ClimateType;
import top.mcpbs.games.uhc.uhcworldgenerator.biomegrid.MapLayerZoom.ZoomType;
...
public abstract class MapLayer {
    ...
    public static MapLayer[] initialize(long seed, int environment, int worldType) {
        ...
        int zoom = 2;
        if (worldType == VanillaGenerator.TYPE_LARGE_BIOMES) {
            zoom = 4;
        }
