...
import top.mcpbs.games.uhc.uhcworldgenerator.biomegrid.MapLayer;
import top.mcpbs.games.uhc.uhcworldgenerator.ground.*;
import top.mcpbs.games.uhc.uhcworldgenerator.noise.PerlinOctaveGenerator;
import top.mcpbs.games.uhc.uhcworldgenerator.noise.SimplexOctaveGenerator;
...
public class NormalGenerator extends VanillaGenerator {
    ...
    public void init(ChunkManager level, NukkitRandom random) {
        ...
        this.populators = ImmutableList.of(
                new PopulatorOre(STONE, new OreType[]{
                        new OreType(Block.get(COAL_ORE), 20 * 10, 17, 0, 128),
                        new OreType(Block.get(IRON_ORE), 20 * 10, 9, 0, 64),
                        new OreType(Block.get(REDSTONE_ORE), 8 * 10, 8, 0, 16),
                        new OreType(Block.get(LAPIS_ORE), 8 * 10, 7, 0, 16),
                        new OreType(Block.get(GOLD_ORE), 16 * 10, 9, 0, 32),
                        new OreType(Block.get(DIAMOND_ORE), 4 * 10, 8, 0, 16),
                        new OreType(Block.get(EMERALD_ORE), 4 * 10, 8, 0, 16),
    ...
    protected static class BiomeHeight {
        ...
        public static final BiomeHeight DEFAULT = new BiomeHeight(0.1d / 100,0.2d);
        public static final BiomeHeight FLAT_SHORE = new BiomeHeight(0d / 100, 0.025d);
        public static final BiomeHeight HIGH_PLATEAU = new BiomeHeight(1.5d / 100, 0.025d);
        public static final BiomeHeight FLATLANDS = new BiomeHeight(0.125d / 100,  0.05d);
        public static final BiomeHeight SWAMPLAND = new BiomeHeight(-0.2d / 100,  0.1d);
        public static final BiomeHeight MID_PLAINS = new BiomeHeight( 0.2d / 100,  0.2d);
        public static final BiomeHeight FLATLANDS_HILLS = new BiomeHeight(0.275d / 100, 0.25d);
        public static final BiomeHeight SWAMPLAND_HILLS = new BiomeHeight( -0.1d / 100, 0.3d);
        public static final BiomeHeight LOW_HILLS = new BiomeHeight(0.2d / 100, 0.3d);
        public static final BiomeHeight HILLS = new BiomeHeight(0.45d / 100, 0.3d);
        public static final BiomeHeight MID_HILLS2 = new BiomeHeight(0.1d / 100, 0.4d);
        public static final BiomeHeight DEFAULT_HILLS = new BiomeHeight( 0.2d / 100,  0.4d);
        public static final BiomeHeight MID_HILLS = new BiomeHeight( 0.3d / 100,  0.4d);
        public static final BiomeHeight BIG_HILLS = new BiomeHeight( 0.525d / 100, 0.55d);
        public static final BiomeHeight BIG_HILLS2 = new BiomeHeight( 0.55d / 100, 0.5d);
        public static final BiomeHeight EXTREME_HILLS = new BiomeHeight(1d / 100,  0.5d);
        public static final BiomeHeight ROCKY_SHORE = new BiomeHeight(0.1d / 100, 0.8d);
        public static final BiomeHeight LOW_SPIKES = new BiomeHeight(0.4125d / 100, 1.325d);
        public static final BiomeHeight HIGH_SPIKES = new BiomeHeight( 1.1d / 100,  1.3125d);
        public static final BiomeHeight RIVER = new BiomeHeight(-0.5d / 100,  0d);
        public static final BiomeHeight OCEAN = new BiomeHeight(-1d / 100,  0.1d);
        public static final BiomeHeight DEEP_OCEAN = new BiomeHeight( -1.8d / 100, 0.1d);
